...
mixin _$WeatherState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Weather weather, List<Forecast> forecast) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Weather weather, List<Forecast> forecast)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Weather weather, List<Forecast> forecast});
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required this.weather, required final List<Forecast> forecast})
      : _forecast = forecast;
  ...
  int get hashCode => Object.hash(
      runtimeType, weather, const DeepCollectionEquality().hash(_forecast));
...
abstract class _Loaded implements WeatherState {
  const factory _Loaded(
      ...
      required final List<Forecast> forecast}) = _$LoadedImpl;
